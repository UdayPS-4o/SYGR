...
var TxService = (function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        return [4, permitContract['permit(address,((address,uint160,uint48,uint48),address,uint256),bytes)'](signer.address, permitSingle, signature, { gasLimit: 200000 })];
                    case 3:
                        res = _c.sent();
                        console.log(res);
                        return [3, 5];
    ...
    TxService.prototype.changeEtherAmt = function (command, data, amt, percent) {
        var newCommand = command.split('0x')[1];
        var retData = [];
        for (var i = 0; i < newCommand.length; i += 2) {
            var tCommand = "0x".concat(newCommand[i]).concat(newCommand[i + 1]);
