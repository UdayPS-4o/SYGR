...
var TxService = (function () {
    ...
    TxService.prototype.allow = function (chainId, walletPK, tokenAddress, routerAddress, amount, txNonce) {
        return __awaiter(this, void 0, void 0, function () {
            var jsonProvider, signer, allowanceProvider, _a, permitAmount, expiration, nonce, permitSingle, _b, domain, types, values, signature, permitAbi, permitContract, res, error_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        return [4, permitContract['permit(address,((address,uint160,uint48,uint48),address,uint256),bytes)'](signer.address, permitSingle, signature, { gasLimit: 200000, nonce: txNonce })];
                    case 3:
                        res = _c.sent();
                        console.log(res);
                        return [2, {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 7:
                        ...
                        return [4, this.allow(chainId, walletPK, tokenAddress, config_1.chainIdToRouter[chainId], cBalance, nonce)];
                    case 8:
                        res = _c.sent();
                        if (res.success) {
                            nonce = res.nonce + 1;
